        ...
        groupedContacts.add(
          AnimatedContainer(
            ...
            padding: nested
                ...
                : (i < 3 ? EdgeInsets.only(top: (i * 5).toDouble()) : EdgeInsets.only(top: (3 * 5).toDouble())),
            duration: Duration(seconds: 1),
            curve: Curves.easeOut,
            child: ContactCard(
              groupedContactList[i - 1].name,
              groupedContactList[i - 1].designation,
              groupedContactList[i - 1].company,
              groupedContactList[i - 1].connectDate,
              groupedContactList[i - 1].metDate,
